...
from lin_lab_to_nwb.osakada_2022 import Osakada2022NWBConverter
...
def session_to_nwb(data_dir_path: Union[str, Path], output_dir_path: Union[str, Path], stub_test: bool = False):
    ...
    converter = Osakada2022NWBConverter(source_data=source_data)
    ...
    editable_metadata_path = Path(__file__).parent / "osakada_2022_metadata.yaml"
